	...
	do
	{
		...
		{	
			...
			if(number<guess)
			{
				...
				//As you know if i increase or decrease total attempts then i make changes everywhere so, 
				//if i missed to update even single place spo it may create big problem.
				//*Thats way i reject 2.5 or all game update 2 series.*
